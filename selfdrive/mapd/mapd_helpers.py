...
traffic_lights = True # op_params.get('traffic_lights', True)
traffic_lights_without_direction = False # op_params.get('traffic_lights_without_direction', False)
rolling_stop = False # op_params.get('rolling_stop', False)
